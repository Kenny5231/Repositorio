...
public class BattleShip extends JFrame
{
	...
	private Container c;
       //no se usa por lomenos en esta clase solo el demo
	...
	public BattleShip()
	{       //esta clase es para las opciones del panel de arriba la de exit es buena idea
		super("BattleShip");
		c = getContentPane();
	...
	{//lo mismo de menu de inicio lo de los modos nos puede servir
			...
			if (e.getSource()==internet)
			{
				try
				{
					...
					status.setText(" Location: " + Connection.getMyIP() + "     Port: " + gamePort);
                        ...
                        //analisa el modo de juego pude servir
			if (e.getSource()==easy)
			{
	...
	{//esta es el public de arriba y llama al resto de clases
